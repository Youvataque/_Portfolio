        ...
        <div className='ContactRow'>
            ...
            <div className='ContactColumn'>
                ...
                <div className='CenterContactL'>
                    <ContactLinks titles={socialContact.titles} links={socialContact.links} wichBody={'ContactLinksBody2'}/> {/* Call ContactGenerator component */}
                </div>
            </div>
        </div>
    </div>
